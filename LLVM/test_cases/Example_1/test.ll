...
entry:
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !68, metadata !56), !dbg !69
  store i32 0, i32* %i, align 4, !dbg !70
  br label %while.cond, !dbg !71

while.cond:                                       ; preds = %while.body, %entry
  %0 = load i32* %i, align 4, !dbg !71
  %cmp = icmp slt i32 %0, 1, !dbg !71
  br i1 %cmp, label %while.body, label %while.end, !dbg !71

while.body:                                       ; preds = %while.cond
  call void @llvm.dbg.declare(metadata !{i32* %temp}, metadata !72, metadata !56), !dbg !74
  %1 = load i32* @Global, align 4, !dbg !75
  %add = add nsw i32 %1, 1, !dbg !75
  store i32 %add, i32* %temp, align 4, !dbg !75
  %2 = load i32* %temp, align 4, !dbg !76
  store i32 %2, i32* @Global, align 4, !dbg !76
  %3 = load i32* %i, align 4, !dbg !77
...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{i8** %x.addr}, metadata !79, metadata !56), !dbg !80
...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{[1 x %struct._opaque_pthread_t*]* %t}, metadata !83, metadata !56), !dbg !91
  %call = call i32 @pthread_mutex_init(%struct._opaque_pthread_mutex_t* @lock, %struct._opaque_pthread_mutexattr_t* null), !dbg !92
  %arrayidx = getelementptr inbounds [1 x %struct._opaque_pthread_t*]* %t, i32 0, i64 0, !dbg !93
  %call1 = call i32 @pthread_create(%struct._opaque_pthread_t** %arrayidx, %struct._opaque_pthread_attr_t* null, i8* (i8*)* @_Z7Thread1Pv, i8* null), !dbg !93
  call void @_Z24inc_counter_without_lockv(), !dbg !94
  %arrayidx2 = getelementptr inbounds [1 x %struct._opaque_pthread_t*]* %t, i32 0, i64 0, !dbg !95
  %0 = load %struct._opaque_pthread_t** %arrayidx2, align 8, !dbg !95
  %call3 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* %0, i8** null), !dbg !95
  %call4 = call i32 @pthread_mutex_destroy(%struct._opaque_pthread_mutex_t* @lock), !dbg !96
  %1 = load i32* @Global, align 4, !dbg !97
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str, i32 0, i32 0), i32 %1), !dbg !97
  ret i32 0, !dbg !98
}
...
!0 = metadata !{metadata !"0x11\004\00clang version 3.6.0 (221053)\000\00\000\00\001", metadata !1, metadata !2, metadata !3, metadata !32, metadata !45, metadata !2} ; [ DW_TAG_compile_unit ] [/Users/arunk/Code/LLVM/test_cases/Example_1/test.cpp] [DW_LANG_C_plus_plus]
!1 = metadata !{metadata !"test.cpp", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_1"}
!2 = metadata !{}
...
!5 = metadata !{metadata !"/usr/include/sys/_pthread/_pthread_types.h", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_1"}
...
!34 = metadata !{metadata !"0x29", metadata !1}   ; [ DW_TAG_file_type ] [/Users/arunk/Code/LLVM/test_cases/Example_1/test.cpp]
...
!49 = metadata !{metadata !"/usr/include/sys/_pthread/_pthread_mutex_t.h", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_1"}
...
!55 = metadata !{metadata !"0x100\00i\0012\000", metadata !33, metadata !34, metadata !44} ; [ DW_TAG_auto_variable ] [i] [line 12]
!56 = metadata !{metadata !"0x102"}               ; [ DW_TAG_expression ]
!57 = metadata !{i32 12, i32 9, metadata !33, null}
...
!61 = metadata !{metadata !"0xb\0013\0018\000", metadata !1, metadata !33} ; [ DW_TAG_lexical_block ] [/Users/arunk/Code/LLVM/test_cases/Example_1/test.cpp]
...
!73 = metadata !{metadata !"0xb\0023\0018\001", metadata !1, metadata !37} ; [ DW_TAG_lexical_block ] [/Users/arunk/Code/LLVM/test_cases/Example_1/test.cpp]
...
!86 = metadata !{metadata !"/usr/include/sys/_pthread/_pthread_t.h", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_1"}
...
!97 = metadata !{i32 45, i32 5, metadata !41, null}
!98 = metadata !{i32 46, i32 1, metadata !41, null}
