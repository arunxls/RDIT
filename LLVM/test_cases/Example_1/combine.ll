...
entry:
  ...
  %0 = bitcast %struct._opaque_pthread_t** %arrayidx to i8*, !dbg !94
  call void @__arunk_create(i8* %0), !dbg !94
  ...
  call void @__arunk_read4(i8* bitcast (i32* @Global to i8*)), !dbg !97
  %4 = load i32* @Global, align 4, !dbg !97
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str, i32 0, i32 0), i32 %4), !dbg !97
  ret i32 0, !dbg !98
}
...
!51 = metadata !{metadata !"clang version 3.6.0 (221053)"}
