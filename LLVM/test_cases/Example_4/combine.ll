...
entry:
  %0 = call i8* @llvm.returnaddress(i32 0), !dbg !67
  call void @__arunk_func_entry(i8* %0), !dbg !67
  call void @__arunk_init(), !dbg !67
  %call = call i32 @pthread_mutex_lock(%struct._opaque_pthread_mutex_t* @lock), !dbg !67
  call void @__arunk_lock(i8* bitcast (%struct._opaque_pthread_mutex_t* @lock to i8*)), !dbg !68
  call void bitcast (void (i8*)* @__arunk_func_exit to void ()*)(), !dbg !68
  ret void, !dbg !68
}
...
; Function Attrs: ssp uwtable
define void @missed_2() #2 {
entry:
  %0 = call i8* @llvm.returnaddress(i32 0), !dbg !69
  call void @__arunk_func_entry(i8* %0), !dbg !69
  call void @__arunk_init(), !dbg !69
  %call = call i32 @pthread_mutex_unlock(%struct._opaque_pthread_mutex_t* @lock), !dbg !69
  call void @__arunk_unlock(i8* bitcast (%struct._opaque_pthread_mutex_t* @lock to i8*)), !dbg !70
...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{i8** %x.addr}, metadata !71, metadata !56), !dbg !72
  call void @missed_1(), !dbg !73
  call void @_Z11inc_counterv(), !dbg !74
  call void @missed_2(), !dbg !75
  ret i8* null, !dbg !76
}
...
entry:
  ...
  %call = call i32 @pthread_mutex_init(%struct._opaque_pthread_mutex_t* @lock, %struct._opaque_pthread_mutexattr_t* null), !dbg !77
  call void @llvm.dbg.declare(metadata !{[1 x %struct._opaque_pthread_t*]* %t}, metadata !78, metadata !56), !dbg !86
  %arrayidx = getelementptr inbounds [1 x %struct._opaque_pthread_t*]* %t, i32 0, i64 0, !dbg !87
  %call1 = call i32 @pthread_create(%struct._opaque_pthread_t** %arrayidx, %struct._opaque_pthread_attr_t* null, i8* (i8*)* @_Z7Thread1Pv, i8* null), !dbg !87
  %0 = bitcast %struct._opaque_pthread_t** %arrayidx to i8*, !dbg !88
  call void @__arunk_create(i8* %0), !dbg !88
  call void @missed_1(), !dbg !88
  call void @_Z11inc_counterv(), !dbg !89
  call void @missed_2(), !dbg !90
  %arrayidx2 = getelementptr inbounds [1 x %struct._opaque_pthread_t*]* %t, i32 0, i64 0, !dbg !91
  %1 = bitcast %struct._opaque_pthread_t** %arrayidx2 to i8*, !dbg !91
  call void @__arunk_read8(i8* %1), !dbg !91
  %2 = load %struct._opaque_pthread_t** %arrayidx2, align 8, !dbg !91
  %call3 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* %2, i8** null), !dbg !91
  %3 = bitcast %struct._opaque_pthread_t* %2 to i8*, !dbg !92
  call void @__arunk_join(i8* %3), !dbg !92
  %call4 = call i32 @pthread_mutex_destroy(%struct._opaque_pthread_mutex_t* @lock), !dbg !92
  ret i32 0, !dbg !93
}
...
!0 = metadata !{metadata !"0x11\004\00clang version 3.6.0 (221053)\000\00\000\00\001", metadata !1, metadata !2, metadata !3, metadata !32, metadata !46, metadata !2} ; [ DW_TAG_compile_unit ] [/Users/arunk/Code/LLVM/test_cases/Example_4/test.cpp] [DW_LANG_C_plus_plus]
!1 = metadata !{metadata !"test.cpp", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_4"}
!2 = metadata !{}
...
!5 = metadata !{metadata !"/usr/include/sys/_pthread/_pthread_types.h", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_4"}
...
!33 = metadata !{metadata !"0x2e\00inc_counter\00inc_counter\00_Z11inc_counterv\008\000\001\000\000\00256\000\008", metadata !1, metadata !34, metadata !35, null, void ()* @_Z11inc_counterv, null, null, metadata !2} ; [ DW_TAG_subprogram ] [line 8] [def] [inc_counter]
!34 = metadata !{metadata !"0x29", metadata !1}   ; [ DW_TAG_file_type ] [/Users/arunk/Code/LLVM/test_cases/Example_4/test.cpp]
...
!38 = metadata !{metadata !"0x2e\00missed_2\00missed_2\00\0024\000\001\000\000\00256\000\0024", metadata !1, metadata !34, metadata !35, null, void ()* @missed_2, null, null, metadata !2} ; [ DW_TAG_subprogram ] [line 24] [def] [missed_2]
!39 = metadata !{metadata !"0x2e\00Thread1\00Thread1\00_Z7Thread1Pv\0030\000\001\000\000\00256\000\0030", metadata !1, metadata !34, metadata !40, null, i8* (i8*)* @_Z7Thread1Pv, null, null, metadata !2} ; [ DW_TAG_subprogram ] [line 30] [def] [Thread1]
...
!50 = metadata !{metadata !"/usr/include/sys/_pthread/_pthread_mutex_t.h", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_4"}
...
!52 = metadata !{metadata !"clang version 3.6.0 (221053)"}
!53 = metadata !{i32 2, metadata !"Dwarf Version", i32 2}
!54 = metadata !{i32 2, metadata !"Debug Info Version", i32 2}
!55 = metadata !{metadata !"0x100\00i\009\000", metadata !33, metadata !34, metadata !45} ; [ DW_TAG_auto_variable ] [i] [line 9]
!56 = metadata !{metadata !"0x102"}               ; [ DW_TAG_expression ]
!57 = metadata !{i32 9, i32 9, metadata !33, null}
!58 = metadata !{i32 9, i32 5, metadata !33, null}
!59 = metadata !{i32 10, i32 5, metadata !33, null}
!60 = metadata !{metadata !"0x100\00temp\0011\000", metadata !61, metadata !34, metadata !45} ; [ DW_TAG_auto_variable ] [temp] [line 11]
!61 = metadata !{metadata !"0xb\0010\0018\000", metadata !1, metadata !33} ; [ DW_TAG_lexical_block ] [/Users/arunk/Code/LLVM/test_cases/Example_4/test.cpp]
!62 = metadata !{i32 11, i32 13, metadata !61, null}
!63 = metadata !{i32 11, i32 9, metadata !61, null}
!64 = metadata !{i32 12, i32 9, metadata !61, null}
!65 = metadata !{i32 13, i32 9, metadata !61, null}
!66 = metadata !{i32 15, i32 1, metadata !33, null}
!67 = metadata !{i32 20, i32 9, metadata !37, null}
!68 = metadata !{i32 21, i32 9, metadata !37, null}
!69 = metadata !{i32 25, i32 9, metadata !38, null}
!70 = metadata !{i32 26, i32 9, metadata !38, null}
!71 = metadata !{metadata !"0x101\00x\0016777246\000", metadata !39, metadata !34, metadata !29} ; [ DW_TAG_arg_variable ] [x] [line 30]
!72 = metadata !{i32 30, i32 21, metadata !39, null}
!73 = metadata !{i32 31, i32 5, metadata !39, null}
!74 = metadata !{i32 32, i32 5, metadata !39, null}
!75 = metadata !{i32 33, i32 5, metadata !39, null}
!76 = metadata !{i32 34, i32 5, metadata !39, null}
!77 = metadata !{i32 38, i32 5, metadata !42, null}
!78 = metadata !{metadata !"0x100\00t\0040\000", metadata !42, metadata !34, metadata !79} ; [ DW_TAG_auto_variable ] [t] [line 40]
!79 = metadata !{metadata !"0x1\00\000\0064\0064\000\000\000", null, null, metadata !80, metadata !84, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 64, align 64, offset 0] [from pthread_t]
!80 = metadata !{metadata !"0x16\00pthread_t\0030\000\000\000\000", metadata !81, null, metadata !82} ; [ DW_TAG_typedef ] [pthread_t] [line 30, size 0, align 0, offset 0] [from __darwin_pthread_t]
!81 = metadata !{metadata !"/usr/include/sys/_pthread/_pthread_t.h", metadata !"/Users/arunk/Code/LLVM/test_cases/Example_4"}
!82 = metadata !{metadata !"0x16\00__darwin_pthread_t\00118\000\000\000\000", metadata !5, null, metadata !83} ; [ DW_TAG_typedef ] [__darwin_pthread_t] [line 118, size 0, align 0, offset 0] [from ]
!83 = metadata !{metadata !"0xf\00\000\0064\0064\000\000", null, null, metadata !"_ZTS17_opaque_pthread_t"} ; [ DW_TAG_pointer_type ] [line 0, size 64, align 64, offset 0] [from _ZTS17_opaque_pthread_t]
!84 = metadata !{metadata !85}
!85 = metadata !{metadata !"0x21\000\001"}        ; [ DW_TAG_subrange_type ] [0, 0]
!86 = metadata !{i32 40, i32 15, metadata !42, null}
!87 = metadata !{i32 41, i32 5, metadata !42, null}
!88 = metadata !{i32 43, i32 5, metadata !42, null}
!89 = metadata !{i32 44, i32 5, metadata !42, null}
!90 = metadata !{i32 45, i32 5, metadata !42, null}
!91 = metadata !{i32 47, i32 5, metadata !42, null}
!92 = metadata !{i32 48, i32 5, metadata !42, null}
!93 = metadata !{i32 51, i32 1, metadata !42, null}
