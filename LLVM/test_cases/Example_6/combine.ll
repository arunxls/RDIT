...
entry:
  ...
  call void @__arunk_lock(i8* bitcast (%struct._opaque_pthread_mutex_t* @lock to i8*)), !dbg !70
  call void @_Z1fv(), !dbg !70
  %call1 = call i32 @pthread_mutex_unlock(%struct._opaque_pthread_mutex_t* @lock), !dbg !71
  call void @__arunk_unlock(i8* bitcast (%struct._opaque_pthread_mutex_t* @lock to i8*)), !dbg !72
...
entry:
  ...
  call void @__arunk_lock(i8* bitcast (%struct._opaque_pthread_mutex_t* @lock to i8*)), !dbg !88
  ...
  %0 = bitcast %struct._opaque_pthread_t** %arrayidx to i8*, !dbg !89
  call void @__arunk_create(i8* %0), !dbg !89
  call void @_Z1fv(), !dbg !89
  %call3 = call i32 @pthread_mutex_unlock(%struct._opaque_pthread_mutex_t* @lock), !dbg !90
  call void @__arunk_unlock(i8* bitcast (%struct._opaque_pthread_mutex_t* @lock to i8*)), !dbg !91
  %arrayidx4 = getelementptr inbounds [1 x %struct._opaque_pthread_t*]* %t, i32 0, i64 0, !dbg !91
  %1 = bitcast %struct._opaque_pthread_t** %arrayidx4 to i8*, !dbg !91
  call void @__arunk_read8(i8* %1), !dbg !91
  %2 = load %struct._opaque_pthread_t** %arrayidx4, align 8, !dbg !91
  %call5 = call i32 @"\01_pthread_join"(%struct._opaque_pthread_t* %2, i8** null), !dbg !91
  ...
  call void @__arunk_read4(i8* bitcast (i32* @Global to i8*)), !dbg !93
  %4 = load i32* @Global, align 4, !dbg !93
  %call7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str, i32 0, i32 0), i32 %4), !dbg !93
  ret i32 0, !dbg !94
}
